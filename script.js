    ...
    if(cnpj.trim() == "") {
        ...
        fetch('layout.xml')
            ...
            .then(xmlContent => {
                ...
                valorServicoTag.textContent = parseFloat(valor.toFixed(2))
                const baseCalculoTag = xmlDoc.querySelector('Valores > BaseCalculo')
                baseCalculoTag.textContent = parseFloat(valor.toFixed(2))
